...
Точность модели BERT при тонкой настройки методом активного обучения, BALD. В каждой итерации добавляются по 100 новых точек данных, которые подбирались с помощью BALD
